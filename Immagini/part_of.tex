...
\begin{tikzpicture}
    ...
    (e1.0)--++(0.75,0)node[draw, diamond, shape aspect=2, inner sep=0.2pt, anchor=180](r1){\tiny Composizione}node[midway, above]{\scriptsize $(0,N)$}
    ...
    (0,-1.5)node[draw, rectangle, anchor=90](e1){Entità 1}
    (e1.90)--++(0,0.22)node[draw, circle, inner sep=1pt, fill=black]{}node[above]{\footnotesize Attributo 1}
    (e1.0)--++(0.75,0)node[draw, diamond, shape aspect=2, inner sep=0.2pt, anchor=180](r1){\tiny Composizione}node[midway, above]{\scriptsize $(0,N)$}
    (r1.0)--++(0.75,0)node[midway, above]{\scriptsize $(0,1)$}--++(0.1,0)node[draw, rectangle, anchor=180](e1){Entità 2}
    (e1.90)--++(0,0.22)node[draw, circle, inner sep=1pt, fill=black]{}node[above]{\footnotesize Attributo 2}
