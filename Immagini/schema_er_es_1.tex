...
\begin{tikzpicture}
    ...
    (r1.270)--++(0,-0.2)node[draw, circle, inner sep=0.5pt,fill=black](a){}--++(0,-0.1)node[above right]{\scriptsize (1,1)}node[draw, rectangle, anchor=90](edizione){Edizione}
    (edizione.355)--++(0.1,0)node[draw, circle, inner sep=0.5pt,fill=black](c){}--++(0.15,0)node[draw, circle, inner sep=1pt,anchor=180]{}node[right]{\footnotesize Anno}
    ...
    % collana
    (edizione.10)--++(0.1,0)node[draw, circle, inner sep=0.5pt,fill=black](b){}--++(0.6,0)node[draw, diamond, shape aspect=2, inner sep=3pt, anchor=180](r3){}
