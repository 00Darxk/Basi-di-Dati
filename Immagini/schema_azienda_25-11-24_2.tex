...
\begin{tikzpicture}
    ...
    %%* Dipartimento
    (dip.270)--++(0,-0.3)node[right]{\scriptsize $(1,1)$}node[draw, diamond, shape aspect=2, inner sep=0.2pt, anchor=90](r1){\footnotesize Comp.}
    (dip.350)--++(0.25,-0.15)node[draw, circle, inner sep=1pt, fill=black]{}node[right]{\footnotesize Nome}
    (dip.10)--++(0.25,0.15)node[above]{\scriptsize $(1,1)$}node[draw, circle, inner sep=1pt, fill=white]{}node[right]{\footnotesize Telefono}
    
    %%* Sede
    (r1.270)--++(0,-0.2)node[draw, circle, inner sep=0.5pt, fill=black](a){}--++(0,-0.1)node[above right]{\scriptsize $(1,N)$}node[draw, rectangle, anchor=90](prg){Sede}
    (prg.10)--++(0.1,0.06)node[draw, circle, inner sep=0.5pt, fill=black](b){}--++(0.15,0.09)node[draw, circle, inner sep=1pt, fill=black]{}node[right]{\footnotesize Città}
