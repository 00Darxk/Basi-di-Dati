...
\begin{tikzpicture}
    ...
    (r1.90)++(0,0.5)node[draw, rectangle, anchor=270](e0){Entità 1}
    ...
    (e0.10)--++(.25,.15)node[draw, circle, inner sep=1pt, fill=white]{}node[right]{\footnotesize B2}
    (e0.350)--++(.25,-.15)node[draw, circle, inner sep=1pt, fill=white]{}node[right]{\footnotesize B3}

    %%* Entità 2
    (r1.0)--++(0.65,0)node[midway, above]{\scriptsize $(1,1)$}node[draw, circle, inner sep=0.5pt, fill=black](a){}--++(0.1,0)node[draw, rectangle, anchor=180](e2){Entità 1.B}
    (e2.10)--++(.25,.15)node[draw, circle, inner sep=1pt, fill=white]{}node[right]{\footnotesize B1}
    (e2.350)--++(.25,-.15)node[draw, circle, inner sep=1pt, fill=white]{}node[right]{\footnotesize B2}
