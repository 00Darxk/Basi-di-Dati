...
\begin{tikzpicture}
    ...
    (r6.270)--++(0,-0.2)node[draw, circle, inner sep=1pt, fill=black](a){}--++(0,-0.1)node[above right]{\scriptsize $(1,1)$}node[draw, rectangle, anchor=90](partecipazione){Partecipazione}
    ...
    %%* Orchestrale
    (partecipazione.270)node[below left]{\scriptsize $(1,1)$}--++(0,-0.1)node[draw, circle, inner sep=1pt, fill=black](b){}--++(0,-0.2)node[draw, diamond, shape aspect=2, inner sep=3pt, anchor=90](r5){}
