...
\begin{tikzpicture}
    ...
    (e1.270)--++(0,-0.1)node[draw, circle, inner sep=0.5pt, fill=black](c){}--++(0,-0.3)node[draw, diamond, shape aspect=2, inner sep=3pt, anchor=90](r1){}node[midway, right]{\scriptsize $(1,1)$}
    (r1.270)--++(0,-0.3)node[draw, rectangle, anchor=90](e4){Entità 3}node[midway, right]{\scriptsize $(0,N)$}
