...
a cui si riferiscono, altrimenti potrebbe causare dei danni all'intera base di dati. Questa reference dovrebbe essere controllata ad ogni inserimento. Su SQLite si può attivare il controllo della chiave esterna con il comando:
\begin{minted}{sql}
...
\begin{figure}[H]%
    \centering%
    \includegraphics[scale=1.25, trim={0 1cm 0 0}]{traduzione_relationships.pdf}
    \label{fig:traduzione_relationships}
\end{figure}
\begin{align*}
    &\begin{matrix}
...
\begin{figure}[H]%
    \centering%
    \includegraphics[scale=1.25, trim={0 1cm 0 0}]{traduzione_cardinalita_vincoli.pdf}%
\end{figure}
\begin{gather*}
    E_1(\underline{A_1})\\
...
\begin{figure}[H]%
    \centering%
    \includegraphics[scale=1.25]{ristrutturazione_ridondanze.pdf}%
\end{figure}
...
\begin{figure}[H]%
    \centering%
    \includegraphics[scale=1.25]{traduzione_generalizzazione.pdf}%
\end{figure}
...
\begin{figure}[H]%
    \centering%
    \includegraphics[scale=1.25]{traduzione_generalizzazione_1.pdf}%
\end{figure}
...
\begin{figure}[H]%
    \centering%
    \includegraphics[scale=1.25]{traduzione_generalizzazione_2.pdf}%
\end{figure}
...
\begin{figure}[H]%
    \centering%
    \includegraphics[scale=1.25]{traduzione_generalizzazione_3.pdf}%
\end{figure}
...
\begin{figure}[H]%
    \centering%
    \includegraphics[scale=1.25]{ristrutturazione_attributi_eterogenei.pdf}%
\end{figure}
Si possono accorpare entità o relationship raggruppando attributi di concetti diversi acceduti insieme. 
\begin{figure}[H]%
    \centering%
    \includegraphics[scale=1.25]{ristrutturazione_attributi_omogenei.pdf}%
\end{figure}

Si eliminano attributi multivalore, introducendo nuove entità o relationship. 
\begin{figure}[H]%
    \centering%
    \includegraphics[scale=1.25]{ristrutturazione_attributi_multivalore.pdf}%
\end{figure}
Oppure si partizionano relationship con attributi opzionali. 
\begin{figure}[H]%
    \centering%
    \includegraphics[scale=1.25]{ristrutturazione_attributi_multivalore_relationships.pdf}%
\end{figure}
...
Se la cardinalità minima è zero, l'attributo deve ammettere valori nulli. Se la cardinalità massima della relationship è uno, si può evitare di realizzare un'ulteriore tabella, come mostrato in \ref{fig:traduzione_relationships}. 
...
\begin{figure}[H]%
    \centering%
    \includegraphics[scale=1.25, trim={0 1cm 0 1cm}]{traduzione_relationships_identificatore_esterno.pdf}%
\end{figure}
\begin{gather*}
...
\begin{figure}[H]%
    \centering%
    \includegraphics[trim={3cm 1cm 0 0.5cm},scale=0.7]{esempio_2_9-12-24.pdf}%
\end{figure}
...
\begin{itemize}
    \item $R_1$(\myuline{Codice Corso}, Titolo, Crediti, Dipartimento);
    \item $R_2$(\myuline{Codice Corso}, \myuline{Anno}, Docente, Semestre);
    \item $R_3$(\myuline{Docente}, Nome Docente);
    \item $R_4$(\myuline{Dipartimento}, Indirizzo). 
\end{itemize}
...
\begin{figure}[H]%
    \centering%
    \includegraphics{esempio_9-12-24.pdf}%s    
\end{figure}
