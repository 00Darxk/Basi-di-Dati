...
\hypersetup{
    colorlinks=true,
    linkcolor=black,
    pdftitle={Apppunti di Basi di Dati},
...
%% TODO img relationship uno a molti e molti a molti + relazioni corrispondenti
% \begin{figure}[H]%
%     \centering%
%     \includegraphics{}%
% \end{figure}
...
%% TODO img attributo cardinalità maggiore ad uno + relazione corrispondente
% \begin{figure}[H]%
%     \centering%
%     \includegraphics{}%
% \end{figure}
...
%% TODO img attributo derivabile in un'entità, attributo derivabile da altre entità e relationship derivabile 
% \begin{figure}[H]%
%     \centering%
%     \includegraphics{}%
% \end{figure}
...
%% TODO img generalizzazione ristrutturata accorpamento entità figlie in genitore
% \begin{figure}[H]%
%     \centering%
%     \includegraphics{}%
% \end{figure}
...
%% TODO img generalizzazione ristrutturata accorpamento entità genitore in figlie
% \begin{figure}[H]%
%     \centering%
%     \includegraphics{}%
% \end{figure}
...
%% TODO img generalizzazione ristrutturata sostituzione generalizzazione con relationship
% \begin{figure}[H]%
%     \centering%
%     \includegraphics{}%
% \end{figure}
...
%% TODO img entità attributi eterogenei + ristrutturazione partizionamento verticale
% \begin{figure}[H]%
%     \centering%
%     \includegraphics{}%
% \end{figure}
...
%% TODO img entità legate da relationship attributi eterogenei + accorpamento
% \begin{figure}[H]%
%     \centering%
%     \includegraphics{}%
% \end{figure}
...
%% TODO img entità e relationship con attributi multivalore + partizionamento 
% \begin{figure}[H]%
%     \centering%
%     \includegraphics{}%
% \end{figure}
...
%% TODO img relationship cardinalità massima 1 + traduzione + traduzione -1 entità
% \begin{figure}[H]%
%     \centering%
%     \includegraphics{}%
% \end{figure}
...
%% TODO img identificatore esterno su relationship + traduzione
% \begin{figure}[H]%
%     \centering%
%     \includegraphics{}%
% \end{figure}
...
%% TODO img relationship uno ad uno + traduzione
% \begin{figure}[H]%
%     \centering%
%     \includegraphics{}%
% \end{figure} 
...
\begin{figure}[H]%
    \centering%
    \includegraphics[trim={3cm 0 0 0},scale=0.7]{esempio_2_9-12-24.pdf}%
\end{figure}
